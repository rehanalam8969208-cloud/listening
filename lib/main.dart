...
class _MainNavigationScreenState extends State<MainNavigationScreen> {
  ...
  void _initEverything() async {
    await _loadFavorites();
    await _requestPermissionsAndLoadSongs();
  }
  ...
  Future<void> _requestPermissionsAndLoadSongs() async {
    try {
      // Safe permission handling for Android 13/14
      ...
      if (!storageStatus.isGranted || !audioStatus.isGranted) {
        ...
        // Even if denied partially, try requesting manage external or standard audio
                    ...
                    children: [
                      ...
                      Row(
                        ...
                        children: [
                          ...
                          const Text("LISTENING", style: TextStyle(fontSize: 12, fontWeight: FontWeight.w900, letterSpacing: 2, color: Colors.grey)),
                          IconButton(
                            icon: Icon(_favoriteSongIds.contains(_currentSong!.id.toString()) ? Icons.favorite : Icons.favorite_border, color: Colors.red),
                            onPressed: () async {
                              final prefs = await SharedPreferences.getInstance();
                      ...
                      Container(
                        ...
                        child: ClipRRect(borderRadius: BorderRadius.circular(28), child: Image.network(defaultArt, fit: BoxFit.cover)),
                      ),
                      const Spacer(),
                      ...
                      SliderTheme(
                        data: SliderTheme.of(context).copyWith(
                          activeTrackColor: primaryDark, thumbColor: primaryDark, inactiveTrackColor: Colors.black12, trackHeight: 3, thumbShape: const RoundSliderThumbShape(enabledThumbRadius: 6),
                        ),
                        child: Slider(
                      ...
                      Row(
                        ...
                        children: [
                          ...
                          GestureDetector(
                            onTap: () { _isPlaying ? _audioPlayer.pause() : _audioPlayer.play(); setModalState(() {}); },
                            child: Container(
                              width: 75, height: 75,
      ...
      children: [
        ...
        Expanded(
          child: _isLoading 
              ...
              : _allSongs.isEmpty
                  ? Center(child: Text("No songs found. Grant storage permission!", style: TextStyle(color: Colors.grey[600])))
                  : ListView.builder(
                      ...
                      itemBuilder: (context, index) {
                        ...
                        return Container(
                          ...
                          child: ListTile(
                            ...
                            subtitle: Text(song.artist ?? "Unknown", maxLines: 1, overflow: TextOverflow.ellipsis, style: TextStyle(color: Colors.grey[600], fontSize: 13)),
        ...
        children: [
          ...
          Expanded(
            child: ListView(
              children: [
                ListTile(
                  leading: Container(padding: const EdgeInsets.all(8), decoration: BoxDecoration(color: accentBlue.withOpacity(0.1), borderRadius: BorderRadius.circular(10)), child: const Icon(Icons.favorite, color: Colors.red)),
    ...
    return Center(
      child: Column(
        ...
        children: [
          ...
          Text("Listening App Edition", style: TextStyle(color: Colors.grey[600], fontSize: 13)),
        ],
      ),
    );
  }
        ...
        child: ClipRRect(
          ...
          child: BackdropFilter(
            ...
            child: Container(
              ...
              child: Row(
                children: [
                  ClipRRect(borderRadius: BorderRadius.circular(12), child: Image.network(defaultArt, width: 44, height: 44, fit: BoxFit.cover)),
